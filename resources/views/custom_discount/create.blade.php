...
@section('content')
<!-- Page Header -->
<x-page-header title="Tambah Custom Discount Baru" subtitle="Buat skema promo diskon baru dengan rentang tanggal dan cakupan barang yang fleksibel.">
...
<form action="{{ route('custom-discount.store') }}" method="POST" class="card-base max-w-2xl space-y-5">
    @csrf
    ...
    <div>
        ...
        <input type="text" name="nama" value="{{ old('nama') }}" required placeholder="Contoh: Promo Spesial Ulang Tahun Apotek" class="form-input @error('nama') error @enderror">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <input type="number" name="persentase" value="{{ old('persentase', 0) }}" min="0" max="50" required class="form-input font-mono @error('persentase') error @enderror">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', now()->format('Y-m-d')) }}" required class="form-input @error('tanggal_mulai') error @enderror">
        ...
        <div>
            ...
            <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', now()->format('Y-m-d')) }}" required class="form-input @error('tanggal_selesai') error @enderror">
