@extends('layouts.app')
@section('title', 'Tambah Pabrik')

@section('content')
<div class="mb-6">
    <h1>Tambah Pabrik Baru</h1>
    <p class="text-caption mt-1">Tambah data pabrikan produsen obat baru.</p>
</div>

<div class="card-base max-w-md">
    <form action="{{ route('pabrik.store') }}" method="POST" class="space-y-4">
        @csrf
